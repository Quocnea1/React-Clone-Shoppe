...
export const productDetailData = {
  title:
    "Áo thun đá banh phong cách retro, thoáng mát",
  info: {
    type: [
      {
        label: "Đen-S",
    ...
    images: ["https://cf.shopee.vn/file/fb23c7e55781945ed3f95630defa6a6f_tn",
...
export const collectionData = {
  ...
  listProducts: [
    ...
    {
      title:
        "Trả góp 0%- Xe Máy Yamaha MT15 chính hãng bảo hành 3 năm",
    ...
    {
      title: "Bộ ga giường cotton tici cao cấp nhập khẩu mẫu mới, drap thun bọc nệm",
    ...
    {
      title: "SET VEST HÀN QUỐC 3 MÓN TAY NGẮN, SET VEST MẶC ĐI CHƠI, SET BLAZER NGẮN TAY",
    ...
    {
      title: "Set Bộ Quần Áo Bóng Đá MU Training Màu Đỏ Mùa 2021/22 - Vải Thái Chuẩn Áo Thi Đấu - Áo Bóng Đá MU",
...
export const headerData = {
  ...
  searchRecommend: ["Dép", "Áo thun", "Quần Đôn chề"],
};
...
export const adminChartData = {
  ...
  salesMonth: {
    lastYear: [100, 300, 500, 700, 900, 1100, 2100, 1800, 100, 300, 500, 700],
    nowYear: [2100, 1800, 100, 300, 500, 700, 100, 300, 500, 700, 900, 1100],
  },
  totalRenuve: 100000000  //tong thu nhap trong nam hien tai
};
